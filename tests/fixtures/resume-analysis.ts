...
export const reactResumeAnalysisResult: ResumeAnalysisResult = {
  ...
  metadata: {
    ...resumeAnalysisResult.metadata,
    analysisProfile: 'REACT_FRONTEND',
    marketProfileVersion: 'market-react-2026-08',
  },
};
...
export const structuredResumeAnalysisResult: ResumeAnalysisResult = {
  ...
  marketFit: {
    ...
    matchedVacancyPercentage: 61,
    targetLevel: 'middle_minus',
    breakdown: {
      score: 84,
      components: [
    ...
    skills: [
      {
        ...
        status: 'STRONG',
        confidence: 0.91,
        evidence: ['Разрабатывал сервисы на Java 17'],
      },
  ...
  skillGaps: {
    gaps: [
      {
        skillId: 'testcontainers',
        skill: 'Testcontainers',
        marketFrequency: 0.27,
        candidateStatus: 'NOT_FOUND',
        priority: 'HIGH',
        estimatedCoverageGain: 0.11,
      },
    ],
  },
  skillRoi: {
    skills: [
      {
        ...
        currentGap: 'HIGH',
        learningEffort: 'LOW',
        estimatedCoverageGain: 0.12,
      },
    ],
  },
  gradeFit: {
    candidateLevel: 'junior_plus',
    targetLevel: 'middle_minus',
    fit: 'SLIGHTLY_UNDERQUALIFIED',
    severity: 'MODERATE',
    score: 68,
    breakdown: null,
  },
  ats: {
    ...
    keywordCoverage: 88,
    diagnostics: [
      { field: 'education', status: 'PARTIAL', issues: ['Не удалось точно определить дату начала обучения.'] },
    ],
    breakdown: null,
  },
  ...
  claimRisks: {
    claims: [
      {
        claim: 'Сократил время запросов',
        valueScore: 9,
        credibilityScore: 8,
        interviewRisk: 7,
        evidenceQuality: 7,
        recommendation: 'KEEP_AND_PREPARE',
        explanation: 'Подготовить методику измерения',
      },
    ],
  },
  interviewRisks: {
    topics: [
      {
        ...
        risk: 'HIGH',
        sourceClaim: 'Сократил время запросов',
        questions: ['Что показал EXPLAIN ANALYZE?'],
      },
    ],
  },
  risks: [
    {
      type: 'EXPERIENCE',
      severity: 'MEDIUM',
      subjectKey: 'experience',
      title: 'Ограниченный коммерческий опыт',
      evidence: '1 год 4 месяца',
      impact: 'Часть вакансий требует 2+ лет',
      action: 'Фокус на Junior+',
    },
  ],
  recommendationAnalysis: {
    items: [
      {
        title: 'Исправить переносы строк',
        category: 'ATS',
        priority: 'HIGH',
        effort: 'LOW',
        expectedImpact: { ats: 6 },
        reason: 'Секции распознаются некорректно',
      },
    ],
  },
